...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 10 23:52:03 2022
...
df = web.DataReader('^GSPC', data_source = 'yahoo', start = '2015-01-01', end = '2021-01-05' )
...
my_GRU_model.fit(X_train,y_train,epochs=100,batch_size=64, verbose=0)
...
#predicted_stock_price = my_GRU_model.predict(X_test)
#predicted_stock_price = sc.inverse_transform(predicted_stock_price)
predicted_stock = np.reshape(GRU_prediction,(378,))

# Creating budget value used for trading strategy
budget = 1000
...
valid['Predictions'] = GRU_prediction
